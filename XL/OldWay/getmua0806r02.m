tic
jsonFile = '\\vs03\VS03-VandC-6\Neuropixels_NHP\Data_collection\m032\20240806\recording2\structure.oebin';

% list_open_ephys_binary(jsonFile, 'continuous')
% 
% list_open_ephys_binary(jsonFile, 'events')

settingsFile = '\\vs03\VS03-VandC-6\Neuropixels_NHP\Data_collection\m032\20240806\settings.xml';

savename = '\\vs03\VS03-VandC-6\Neuropixels_NHP\Data_collection\m032\20240806\recording2\tempmua';
...
BTrialDur = [bdCo-3;bdCo-4;bdCo-5;bdCo-6]; %varies by task
...
% for i=1:100
%     subplot(10,10,i)
%     plot(squeeze(temp_mua(121,i+100,:)))
% end
